...
initPublisher: function(apiKey, session_id, token, t, l, w, len, z) {
    return new TBPublisher(apiKey, session_id, token, t, l, w, len, z);
},
...
TBPublisher = (function() {
               function TBPublisher(apiKey, session_id, token, t, l, w, len, z) {
               ...
               this.sanitizeInputs(apiKey, "test", null);
               ...
               Cordova.exec(TBSuccess, TBError, OTPlugin, "initPublisher", [apiKey, session_id, token, t, l, w, len, z]);
